import { createExchangeOrder, getExOrderDetail, culcRemainingTime } from '../ex'
import { getShopInfo } from '../../service/shop';
import { URL_CDN } from '../../src/const';
var Utils = require('../../utils/utils');
import { EX_PROTOCOL, DEBUG, prepareTestBean, } from '../exCons'
...
Page({
    ...
    getPreparingExOrder: function () {
        ...
        //----------------------------------   test ----------------------------------------
        if (DEBUG) {
            let exOrderBean = prepareTestBean
