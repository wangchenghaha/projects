...
import {timeStamp ,formatPreTimer, jiafa, orderStatus, skuToImg} from '../../utils/utils'
  ...
  methods: {
    ...
    preOrderStatus: function(depositStatus, balanceStatus, presellDeadline){
      ...
      if(depositStatus === 'WaitingPay' && balanceStatus === 'WaitingPay' && times < preDeadTime){
        ...
        status = orderStatus(balanceStatus)
        isClick = false;
      }
      this.setData({
        isClick,
