...
import {lotteryAdaper0501} from '../lotteryAdapter'
...
Page({
   ...
   */
  data: {
    lotteryBg: splitGameImg("lottery_0501new_bg.jpg?v=05", 'lottery'),
    turnTop: "40%",
    btnTop: "85%;",
    contentTop: '90%',
    drawPointer: splitGameImg("lottery_0501_go_new.png?v=0512", 'lottery'),
  ...
  _getGiftRecords(){
    ...
    getGiftRecords('school').then(res =>{
  ...
  //跳转首页
  goShop: function () {
    app.tdSdkEvent('adpage_to_home_btn_click', {
