...
class jumpGameFunction {
  ...
  makeDatas(suiji) {
    ...
    let imgJson = this.gameConst.yunImgArrs[index]
...
scroTop(){
  ...
  // 随机分数(10的1到10倍)
  this.gameConst.fenshu = parseInt(this.gameConst.fenshu) + Math.floor(Math.random() * 11 + 1) * 10
...
makeDatasTG(){
  ...
  this.gameConst.indexImgBG = `${this.gameConst.imgPath}jumpGame_indexTGBG.jpg`
  this.gameConst.currentImg = this.gameConst.animateImgS
  this.gameConst.returnDatas()
}
...
// 15
  if (index == 1){
    ...
    this.gameConst.tongguanNum = 400
    this.gameConst.tgBottomSpeed = 15
    
    this.gameConst.tzNumber = 7
    this.gameConst.indexImgBG = `${this.gameConst.imgPath}jumpGame_indexBG1.jpg`
  }
  else if (index == 2){
    this.gameConst.jumpSpeed = 20
    this.gameConst.duration = 350
    this.gameConst.reloadSpeed = 400
    this.gameConst.tongguanNum = 2300
    this.gameConst.tgBottomSpeed = 20

    this.gameConst.tzNumber = 20
    this.gameConst.indexImgBG = `${this.gameConst.imgPath}jumpGame_indexBG2.jpg`
  }
  else if (index == 3){
    this.gameConst.jumpSpeed = 25
    this.gameConst.duration = 300
    this.gameConst.reloadSpeed = 300
    this.gameConst.tongguanNum = 4500
    this.gameConst.tgBottomSpeed = 25

    this.gameConst.tzNumber = 30
    this.gameConst.indexImgBG = `${this.gameConst.imgPath}jumpGame_indexBG3.jpg`
  }
  else {
    let a = index - 3
    ...
    this.gameConst.tongguanNum = 4500 * (a + 1) + 100
    this.gameConst.tgBottomSpeed = 30

    this.gameConst.tzNumber = 40
    this.gameConst.indexImgBG = `${this.gameConst.imgPath}jumpGame_indexBG3.jpg`
  }
